...
public class TesteBanda {
    ...
    public static void main(String[] args) {
        ...
        InstrumentoMusical violao = new Violao("Violao", "Madeira", 6);
        InstrumentoMusical bateria = new Bateria("Bateria", "Metal", 5);
        ...
        // InstrumentoMusical instrumento = new InstrumentoMusical("Generico", "Metal");
    }
}
